...
app.use(function(req, res, next) {
    res.header("Access-Control-Allow-Origin", "https://github.com/Un-known001/Pokemon.github.io.git");
    res.header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept");
    next();
  });
  
const whitelist = ['http://localhost:8000', 'https://github.com/Un-known001/Pokemon.github.io.git/']
app.use(cors({
    origin: whitelist,
